...
export default function UpdatePasswordPage() {
  ...
  useEffect(() => {
    async function checkSession() {
      ...
      if (!session) {
        setError('No tienes una sesión activa o el enlace ha expirado. Por favor, solicita uno nuevo.');
      }
  ...
  if (checkingSession) {
    return (
      <div className="min-h-screen bg-[#F0F2F5] flex items-center justify-center font-sans">
        <p className="text-[#4B4F56] text-sm animate-pulse">Verificando sesión...</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#F0F2F5] flex items-center justify-center px-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="flex flex-col items-center gap-1 mb-8 text-center">
          ...
          <p className="text-[11px] text-[#4B4F56] font-medium tracking-wide">Actualizar Contraseña</p>
        </div>
        ...
        <div className="bg-white border border-[#DDDFE2] rounded-xl shadow-[0_2px_4px_rgba(0,0,0,0.1),0_8px_16px_rgba(0,0,0,0.1)] overflow-hidden">
          ...
          <div className="border-b border-[#EBEDF0] px-6 py-4 flex justify-center">
             <span className="text-[#28A745] text-xs font-bold border-b-2 border-[#28A745] pb-4 -mb-4">Nueva contraseña</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-5">
            ...
            <button
              type="submit"
              disabled={!!(loading || success || (error && !password))}
            ...
            {error && !password && (
              <div className="text-center pt-2">
                <Link href="/forgot-password" className="text-[11px] text-[#28A745] hover:underline font-bold">
