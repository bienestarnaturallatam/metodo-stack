...
async function proxy(request) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["createServerClient"])(("TURBOPACK compile-time value", "https://jidijybfbgrsmovtalhu.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImppZGlqeWJmYmdyc21vdnRhbGh1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzUwNzk4MzAsImV4cCI6MjA5MDY1NTgzMH0.gXyhYu81iVczpHS_pOC1SspAnDPl7_DHlLG7J_1QSJk"), {
        cookies: {
            getAll () {
    ...
    const isPublicPath = pathname.startsWith('/suspendido') || pathname.startsWith('/login') || pathname.startsWith('/register') || pathname.startsWith('/forgot-password') || pathname.startsWith('/reset-password') || pathname.startsWith('/update-password') || pathname.startsWith('/auth/callback') || pathname.startsWith('/privacidad') || pathname.startsWith('/terminos') || pathname.startsWith('/cookies');
    if (user && !isPublicPath) {
        const { data: profile } = await supabase.from('profiles').select('tier, is_paid, plan_expires_at, created_at').eq('id', user.id).single();
        ...
        if (tier.startsWith('suspended')) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/suspendido', request.url));
        }
        ...
        if (pathname.startsWith('/api/recursos')) {
            if (!isPaid) {
                return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"](JSON.stringify({
                    error: 'Acceso denegado. Se requiere plan de pago.'
                }), {
                    status: 403,
                    headers: {
